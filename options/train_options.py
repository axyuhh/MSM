...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--update_html_freq', type=int, default=200, help='frequency of saving training results to html')
        ...
        self.parser.add_argument('--display_id', type=int, default=7, help='visdom id')
        ...
        self.parser.add_argument('--image_gan_mode', default='lsgan', help='default implementation:[dcgan, lsgam, hinge]')
        self.parser.add_argument('--rec_mode', default='l1', help='default implementation:[l1, mse]')
        self.parser.add_argument('--lr', type=float, default=0.0001, help='initial learning rate for adam')
        self.parser.add_argument('--f_lr', type=float, default=0.000001, help='initial learning rate for adam')
