...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--n_threads', default=8, type=int, help='# sthreads for loading data')
        self.parser.add_argument('--batch_size', type=int, default=1, help='input batch size')
        self.parser.add_argument('--load_size', type=int, default=130, help='scale images to this size')
        self.parser.add_argument('--fine_size', type=int, default=128, help='then crop to this size')
        ...
        ### network parameters
        self.parser.add_argument('--up_type', type=str, default='nearest', help='transpose, nearest, or pixelshuffle')
        self.parser.add_argument('--norm_type', type=str, default='cbin', help='normalization:[cbin, cbbn, adain]')
        self.parser.add_argument('--decoder_norm_type', type=str, default='adain', help='normalization:[cbin, cbbn, adain]')
        ...
        self.parser.add_argument('--n_content_resblocks', type=int, default=6, help='# of content encoder resblocks')
        ...
        self.parser.add_argument('--n_image_disblocks', type=int, default=4, help='# of image discriminator blocks')
        ...
        self.parser.add_argument('--exp_name', type=str, default='DMIT_Season_Transfer',
                                 help='the storing name in checkpoints')
        self.parser.add_argument('--model_name', type=str, default='season_transfer',
                                 help='default model name:[season_transfer, semantic_image_synthesis]')
        self.parser.add_argument('--gpu', type=int, default=0, help='assign gpu for the model, -1 means cpu mode')
